class User < ActiveRecord::Base
  ...
  has_attached_file :avatar, default_url: 'http://asana-clone.herokuapp.com/assets/images/avatar-placeholder-3457dd70fea884c004730991df531cc8eb7d4b9abaca82d5e1b6aff46dde79e9.png';
